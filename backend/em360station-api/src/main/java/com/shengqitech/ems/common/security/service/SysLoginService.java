...
import com.shengqitech.ems.common.constant.UserConstants;
import com.shengqitech.ems.common.exception.ServiceException;
import com.shengqitech.ems.common.exception.user.CaptchaException;
import com.shengqitech.ems.common.exception.user.CaptchaExpireException;
import com.shengqitech.ems.common.exception.user.UserNotExistsException;
...
//        recordLoginInfo(loginUser.getUserId());
    ...
    public void validateCaptcha(String username, String code, String uuid) {
        String verifyKey = CacheConstants.SYSTEM_KEY + CacheConstants.SEGMENT_KEY + CacheConstants.CAPTCHA_CODE_KEY + StringUtils.nvl(uuid, "");
...
//        sysUser.setEms_sysuser_id(userId);
