...
@Component
@Slf4j
public class PollutantRtdValueWebSocket extends BaseWebSocket {
    ...
    public PollutantRtdValueWebSocket() {
    }
    ...
    public void sendMessageToUSERS(TextMessage message) {
        for (String userId : USERS.keySet()) {
            try {
                if (USERS.get(userId).isOpen() && userId.contains("/monitordata/rtdValueList")) {
    ...
    // ems:instanceNo:/monitordata/rtdValueList:0e2b4b13-3b62-005d-3be3-a35aec4cc45a
    // ems:instanceNo:/monitordata/rtdValueList:0e2b4b13-3b62-005d-3be3-a35aec4cc45a
    ...
    private void sendMessage(String path) {
        ...
        for (String s : collect) {
            ...
            sb.append("|> filter(fn: (r) => r[\"dataType\"] == \"pollutantRtdValue\")");
            sb.append("|> last()");
