...
const EditTelphone = React.forwardRef((props, ref: any) => {
  ...
  return (
    ...
    >
      ...
      <StepsForm.StepForm layout="horizontal" name="time" title="完成">
        <Result
          status="success"
          title="修改成功，您的手机号码为133******01"
          subTitle="此手机号码可作为登录名使用，也会作为安全验证的方式用于登录、找回密码、修改手机等场景"
          extra={[
            <Button
              key="buy"
              onClick={() => {
